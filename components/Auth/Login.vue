<template>
  <div class="lg:container overflow-y-scroll">
    <div class="flex justify-center mt-16 lg:mt-14 lg:pt-10">
      <div class="lg:w-1/2 2xl:w-3/5 hidden lg:flex justify-end pt-8">
        <img
      ...
      <div class="w-4/5 lg:w-1/2 2xl:w-2/5 lg:pl-8 2xl:pr-32">
        <div class="flex flex-col items-center">
          <img src="/just_logo.png" alt="" />
          <span class="fs-18 text-blue text-center dark:text-white mt-2"
          ...
          <div class="w-full mt-5">
            <button class="w-full" @click="loginWithEmail()">
              <div class="flex">
                <div
                  class="rounded-l-3xl border border-2 border-color-primary flex justify-center items-center bg-white"
                >
                  <span class="material-icons-outlined text-pink fs-40 mx-5">
                    email
                  </span>
                </div>
                <div
        ...
        <div class="flex flex-col items-center mt-8 login-form">
          <span class="fs-24 text-secondary dark:white">Sign Up</span>

          <input
            class="input-height fs-24 border-lighter border-2 w-full rounded-full dark:bg-black dark:text-white pl-4 mt-5"
            placeholder="E-mail"
            type="text"
          />
          <input
            class="input-height fs-24 border-lighter border-2 w-full rounded-full dark:bg-black dark:text-white pl-4 mt-3"
          ...
          <button
            @click="signUp()"
            class="bg-primary text-white w-full rounded-full dark:bg-black dark:text-white pl-4 input-height fs-24 mt-4 pt-1"
          >
            Sign Up
          </button>
    ...
    <div class="w-full flex flex-col items-center mt-5 lg:mt-32 mb-16">
